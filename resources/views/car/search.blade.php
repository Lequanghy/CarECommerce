 <x-app-layout>
     <main>
         ...
         <section>
             <div class="container">
                 <div class="search-results-toolbar sm:flex items-center justify-between mb-medium">
                     <div class="flex items-center">
                         ...
                         <div>
                             <p class="section-kicker">Inventory search</p>
                             <h2 class="search-results-title">Define your search criteria</h2>
                         </div>
                     </div>
                                         ...
                                         <select id="modelSelect" name="model_id">
                                             ...
                                             @foreach ($models as $model)
                                                 <option value="{{ $model->id }}"
                                                     ...
                                                     {{ request('car_type') == $model->id ? 'selected' : '' }}>
                                                     {{ $model->name }}
                                                 </option>
                                             @endforeach
                                         </select>
                                         ...
                                         <select name="car_type_id">
                                             ...
                                             @foreach ($car_types as $car_type)
                                                 <option value="{{ $car_type->id }}"
                                                     {{ request('car_type_id') == $car_type->id ? 'selected' : '' }}>
                                                     {{ $car_type->name }}
                                                 </option>
                                             @endforeach
                                         </select>
